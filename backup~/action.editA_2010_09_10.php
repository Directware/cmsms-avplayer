...
$playertypeoptions = $this->get_predefinedoptions("player_playertype");
	...
	)
{
	...
	$item->location = $params["Alocation"];
		...
		$item->playertype = $params["Aplayertype"];
...
$this->smarty->assign("parameters_input", $this->CreateInputText($id,"Aparameters",isset($item)?$item->parameters:"",75,TEXT));
...
$this->smarty->assign("playertype_label", $this->Lang("player_playertype"));
$this->smarty->assign("playertype_input", $this->CreateInputDropdown($id,"Aplayertype",$playertypeoptions,-1,isset($item)?$item->playertype:0));
